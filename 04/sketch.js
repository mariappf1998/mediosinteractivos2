...
beginShape();
  ...
  if (mouseIsPressed) {
    ...
    if (herramienta == 9) {
      ...
      vertex(mouseX + 4, mouseY - 1);
      vertex(mouseX - 13, mouseY + 8);
      vertex(mouseX, mouseY - 1);
      endShape(CLOSE);
      
      beginShape();
      vertex(mouseX - 13, mouseY - 10);
      vertex(mouseX + 12, mouseY - 1);
      vertex(mouseX - 13, mouseY + 9);
      vertex(mouseX + 8, mouseY - 1);
      endShape(CLOSE);
    }
    //figura arco
    if (herramienta == 10) {
